        ...
        <div class="grid grid-cols-4 rounded-lg gap-x-4">
            <div
                ...
                <div class="flex items-center">
                    <a href="{{ route('laporan.notaris') }}">
                        <div
                            class="flex items-center justify-center w-20 h-20 text-center transform bg-white rounded-full group hover:bg-primary-600 ">

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-10 h-10 text-primary-500 group-hover:text-white">
            ...
            <div
                ...
                <div class="flex items-center">
                    <a href="{{ route('laporan.ppat') }}">
                        <div
                            class="flex items-center justify-center w-20 h-20 text-center bg-white rounded-full group hover:bg-secondary-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-10 h-10 text-secondary-500 group-hover:text-white">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="flex items-center">
                    <a href="{{ route('laporan.suratmasuk') }}">
                        <div
                            class="flex items-center justify-center w-20 h-20 text-center bg-white rounded-full group hover:bg-warning-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-10 h-10 text-warning-500 group-hover:text-white">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="flex items-center">
                    <a href="{{ route('laporan.suratkeluar') }}">
                        <div
                            class="flex items-center justify-center w-20 h-20 text-center bg-white rounded-full group hover:bg-success-600 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-10 h-10 text-success-500 group-hover:text-white">
                                <path stroke-linecap="round" stroke-linejoin="round"

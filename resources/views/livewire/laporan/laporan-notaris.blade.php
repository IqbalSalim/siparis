        ...
        <div class="relative overflow-x-auto border shadow-md sm:rounded-lg dark:border-gray-700">
            <div class="p-4 bg-white dark:bg-gray-800">
                <div class="flex flex-row items-center justify-between">
                    <div>
                        <h2 class="mb-2 text-xl font-semibold text-primary-500 dark:text-white">Laporan Notaris
                        </h2>
                    </div>
                    <div class="flex items-center gap-x-4">
                        <a href="{{ route('cetak-notaris',[$bulan_awal, $bulan_akhir, $tahun]) }}" target="_blank"

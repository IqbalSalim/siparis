        ...
        <div class="relative w-full h-full max-w-4xl p-4 mx-auto md:h-auto">
            ...
            <div
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-bold text-primary-500 ">Tambah Surat Masuk</h3>
                        ...
                        <div class="flex flex-col space-y-2">
                            <div class="flex items-center gap-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <input type="date" wire:model.defer='tanggal_terima' name="tanggal_terima"
                                        id="tanggal_terima" class="mt-1">
                                    <span class="text-xs text-red-700">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.defer='asal_surat' name="asal_surat" id="asal_surat"
                                    class="mt-1">
                                <span class="text-xs text-red-700">
                                    @error('asal_surat')
                                    {{ $message }}
